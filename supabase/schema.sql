...
drop policy if exists "subjects_all_own" on public.academic_subjects;
...
drop policy if exists "academic_works_all_own" on public.academic_works;
...
drop policy if exists "personal_works_all_own" on public.personal_works;
...
drop policy if exists "milestones_all_own" on public.goal_milestones;
...
drop policy if exists "free_slots_all_own" on public.free_time_slots;
